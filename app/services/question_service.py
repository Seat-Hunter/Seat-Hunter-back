...
- follow_up의 화자는 "평가자"가 아니라, [이번 질문]을 던졌던 그 청중이다.
  발표를 듣다가 궁금해서 이어 묻는 자연스러운 구어체 질문으로 작성해라.
- "~을 원하시는지요", "~을 제안해도 될까요", "~하면 어떨까요"처럼 발표자에게
  기능을 제안하거나 의견·요구사항을 묻는 설문/기획자 말투는 쓰지 않는다.
  청중은 궁금한 걸 묻는 입장이지, 발표자가 뭘 원하는지 물어보는 입장이 아니다.
